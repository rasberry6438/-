...
;
;作成内容の概要：
;2025年3月9日PM7時2分にサービス終了を迎え、7年2カ月の活動に終止符を打った名作メギド72の各種キャラクターのキャラ紹介文です。
;各キャラクターがどのような性格・性質か、口上を書く際の助けとなるよう簡潔に記載しております。
;内容の不備、抜けや、内容を追記したい方はバンバン修正なさってください。
;※種族は全員（追放でも純正でも）「メギド」に統一しております。
;　転生メギドの種族は正確には「ヴィータ（人間）」なのですが、分かりやすくするための処置です。
;
;_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/#
;ライセンスについて
