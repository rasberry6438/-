...
;パッチ名：グリームニル口上
;作者：ひよどり
;作成日：25/01/01　になるはずだったよ
;
;作成内容の概要：何か書きたいよね、で書き溜めています　まだ少量だぞ
;
;以下書いた人のメモ
;恋慕時はちょっとめんどくさいけどすごく懐いてくる大型犬
;セフレ時はめんどくさいの方向性の違う大型犬イメージです
;書いた人は神バハの亡霊なので成分はグラブル7割、神バハ2割、他コラボ1割くらい
;
;_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/#
;ライセンスについて
...
;初期値は空っぽなので、利用する場合は「口上側初期パラメータ変更_166」関数内で初期値を設定してください。
;
;・口上の特殊記法
...
;	+-------------------+-------------------------------------------------------------------+
;	|_COLOR_0166XXX_   |直後の文字列を0166XXXで指定した文字色で表示します                   |
;	+-------------------+-------------------------------------------------------------------+
